...
shinyUI(fluidPage(
    ...
    mainPanel(
        ...
        p("Is Polk City's tax base overly dependent on residential property?"),
        ...
        wellPanel(
            ...
            p("Includes only property located in Polk County. Some cities are mostly in bordering counties."),
